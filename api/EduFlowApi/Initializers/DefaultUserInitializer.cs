...
namespace EduFlowApi.Initializers
{
    public class DefaultUserInitializer
    {
        ...
        public static async Task UserInitializeAsync(UserManager<AuthUser> userManager, RoleManager<Role> roleManager, EduFlowDbContext context, string adminName, string adminLogin, string adminPassword)
        {
            try
            {
                ...
                if (await userManager.FindByEmailAsync(adminLogin) == null)
                {
                    ...
                    var admin = new AuthUser()
                    {
                        ...
                        EmailConfirmed = true,
                        PasswordHash = new PasswordHasher<AuthUser>().HashPassword(null, adminPassword),
