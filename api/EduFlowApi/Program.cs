...
public class Program
{
    public static async Task Main(string[] args)
    {
        ...
        {
            options.UseNpgsql(
                builder.Configuration.GetConnectionString(nameof(EduFlowDbContext))
            );
        });
        ...
        using (var scope = app.Services.CreateScope())
        {
            ...
            try
            {
                ...
                var context = service.GetRequiredService<EduFlowDbContext>();
